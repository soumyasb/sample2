...
import DUVInitData from '../mocks/DUVInit.json';
...
class DUVUpdate extends Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        //     this.setState({ DUVInitData: this.props.dlUpdates.DUVInitData });
        // }
        ...
        switch (field) {
            ...
            case 'ThreeCharacterName':
                ...
                if ((Obj['dlNumber'].length === 8)) {
                    ...
                    //this.props.getDUVData(Obj['dlNumber']);
                }
                break;
            case 'nextDLNumber':
    ...
    onDateChange(d, ds, type) {
        ...
        switch (type) {
            case 'hearingDate':
                ...
                break;
            case 'originalDate':
                this.setState({ Obj: Obj, originalDate: d });
                break;
            default:
                break;
        }
    ...
    handleUpdate(type) {
        ...
        const { Obj, hearingDate, originalDate } = this.state;
        Obj['hearingDate'] = dateFormatFunc(hearingDate);
        Obj['originalDate'] = dateFormatFunc(originalDate);
                            ...
                            <Form className="ant-advanced-search-form">
                                ...
                                <Row>
                                    <Col span={8}>
                                        ...
                                        >
                                            <DatePicker placeholder="Original Date"
                                                value={this.state.originalDate} format={dateFormat} onChange={(d, ds) => { this.onDateChange(d, ds, 'originalDate') }} />
                                        </FormItem>
                                    </Col>
                                    <Col span={8} offset={1}>
                                        <FormItem
                                        ...
                                        >
                                            <Select onChange={e => this.handleFieldChange(e, 'originalReason')}
